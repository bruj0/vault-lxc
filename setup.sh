...
systemd-resolve --interface lxdbr0 --set-dns $LXDBR0_IP --set-domain lxd
systemd-resolve --interface lxdbr1 --set-dns $LXDBR1_IP --set-domain lxd
systemd-resolve --interface lxdbr2 --set-dns $LXDBR2_IP --set-domain lxd
